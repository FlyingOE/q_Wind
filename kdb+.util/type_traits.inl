...
struct q::type_traits<void> {
	...
	static TypeNum const typeNum = 0;
...
struct q::type_traits<C> {
	...
	static TypeNum const typeNum = KC;
...
struct q::type_traits<G> {
	...
	static TypeNum const typeNum = KB;
...
struct q::type_traits<H> {
	...
	static TypeNum const typeNum = KH;
...
struct q::type_traits<I> {
	...
	static TypeNum const typeNum = KI;
...
struct q::type_traits<J> {
	...
	static TypeNum const typeNum = KJ;
...
struct q::type_traits<E> {
	...
	static TypeNum const typeNum = KE;
...
struct q::type_traits<F> {
	...
	static TypeNum const typeNum = KF;
...
struct q::type_traits<S> {
	...
	static TypeNum const typeNum = KS;
